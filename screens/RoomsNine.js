...
useEffect(() => {
    ...
    const { sound } = await Audio.Sound.createAsync(
       {uri: "https://firebasestorage.googleapis.com/v0/b/mindfulfriend-9fe90.appspot.com/o/audiomass-output.mp3?alt=media&token=7b9015c5-9f06-4ae0-ae16-787e01a18140"}
    );
    setSound(sound);
  ...
  return (
    <View style={{justifyContent: "center", alignItems: "center", flex: 1}}>
      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/images/city.mp4")}
        shouldPlay
        resizeMode="contain"
        isLooping
        resizeMode={"cover"}
