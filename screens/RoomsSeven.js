...
useEffect(() => {
    ...
    const { sound } = await Audio.Sound.createAsync(
       {uri: "https://firebasestorage.googleapis.com/v0/b/mindfulfriend-9fe90.appspot.com/o/peace.mp3?alt=media&token=138c0735-ebd0-465f-a635-e396f26fbab6"}
    );
    setSound(sound);
  ...
  return (
    <View style={{justifyContent: "center", alignItems: "center", flex: 1}}>
      <Video
        ref={video}
        style={styles.video}
        source={require("../assets/images/morje.mp4")}
        shouldPlay
        resizeMode="contain"
        isLooping
        resizeMode={"cover"}
